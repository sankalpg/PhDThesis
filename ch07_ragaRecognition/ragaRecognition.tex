...
\begin{figure}[h]
	...
	\end{center}
	\caption{Accuracy of \acrshort{ragarecTDMS_KL} as a function of parameter values. State-of-the-art approaches $\mathcal{E}$ and random baselines $\mathcal{B}$ are also reported for comparison.\TODO{Match $\mathfrak{B}$, wasn't happening in matplotlib}} 
...
\TODO{Add comparison of type of errors made by different method, for this add confusion matrix of other method}
