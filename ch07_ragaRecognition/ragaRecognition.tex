...
\TODO{In this section we aim to utilize the patterns for blah blah. and why we believe its a sensible way, what gap does it fill}
...
\TODO{Give examples of studies which have tried to use language concepts in music!}
