...
\TODO{read description of these datsets in paper, see if you are missing something. PROVIDE A SUMMARY OF STATS, diff attributes.}


\section{Summary}

Add a summary of what we talked about. Add a big table compiling different numbers for different corporas and datasets. This would be a nice way to show in short the diversity in the collection.
