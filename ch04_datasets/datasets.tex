...
\subsection{Criteria for Building CompMusic Corpora}
...
\tablebot
	...
	\caption[Summary of the tonic identification datasets]{Summary of the tonic identification datasets, including average excerpt length (Avg. length),
		...
		unique recordings (\#Urec) and number of unique artists (\#Uartists) in each dataset. For vocal
...
\tabletop
			Dataset   	& 	Rec. 	&	PT		&	\Glspl{raga}	&	Artists		&	Duration\,(hr)\\	
\tablemid
...
\tablebot
		\end{tabular}
		\caption[Details of the melodic similarity datasets]{Details of the melodic similarity datasets in terms of the total number of recordings~(Rec.), number of annotated pattern types~(PT), number of \glspl{raga}, unique number of artists and total duration of the dataset.}
