...
The following is a list of different symbols used in the dissertation along with a short description of each symbol. \TODO{Improve the description}
...
\begin{longtable}{P{15mm}>{\raggedright}p{85mm}}
	...
	\listSymbol{\tdmsNorm}{\ensuremath{{\mathbf{H}}}}{Normalized \acrshort{tdms}}	
	...
	\listSymbol{\indFnc}{\ensuremath{i}}{Index}	
	\listSymbol{\indFnc}{\ensuremath{j}}{Index}		
	\listSymbol{\ragaLikelihood}{\ensuremath{\mathcal{L}}}{Likelihood of the representative \gls{raga} in a community}
	\listSymbol{\indFnc}{\ensuremath{m}}{Index}		
	...
	\listSymbol{\sRate}{\ensuremath{\mathrm{s}}}{Sampling rate of the pitch sequence in Hz}
	\listSymbol{\freqSvara}{\ensuremath{\mathcal{S}}}{Svara frequency in Cents}										%this is S in figures	
	\listSymbol{\toniRec}{\ensuremath{\mathfrak{t}}}{Tonic pitch of an audio recording in Hz}	
	\listSymbol{\timeStamp}{\ensuremath{\mathrm{T}}}{Time stamp}																%this is S in figures
	\listSymbol{\pattVocab}{\ensuremath{\mathcal{V}}}{Vocabulary of melodic phrases}	
	\listSymbol{\edgeWght}{\ensuremath{\mathbf{w}}}{Weight of a network edge}	
	...
	\listSymbol{\mNorm}{\ensuremath{Z}}{Normalization type used in the melody representation}	
...
%---------------------------------
	...
	\nolistSymbol{\uTScaling}{\ensuremath{\timeScaFac}}{Uniform time-scaling factor}	
