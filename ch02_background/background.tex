...
\COMMENT{Since this is one of the core topics, if time permits a richer description should be provided.}
...
\COMMENT{In addition to these two tasks, we also present a brief review of the related literature in time-series analysis domain, since the task of motif discovery is in time-series is well studied.}


\subsection{Key and Tonality Modeling}
\label{sec:background_key_and_tonality_modeling}

\COMMENT{Add pictures to explain concepts, like pcp, HPCP, and fine grained histogram etc}
...
\COMMENT{IF TIME PERMITS: you can explain the methods in a bit more detail...like how they findthe key or maqam. TO conclude we can say something about raga, that its more than a scale so there are other approahes etc etc see above.}


\subsection{Pattern Processing in Music [TODO: 5-6 paragraphs]}
\label{sec:pattern_processin_in_music}

\COMMENT{add some pictures of the concepts}
...
\subsubsection{Motif Discovery in Symbolic Music \TODO{4 paras}}
...
\subsubsection{Structural Segmentation and Audio Thumbnailing \TODO{2 paras}}
...
Repetition-based structural segmentation methodologies are used for a number of other pattern discovery tasks in \gls{mir} such as audio thumbnailing or summary generation. In these tasks the length of the discovered segments are typically shorter than that of an entire music section. \TODO{provide a summary of audio thumbnailing, and related pattern discovery task. This is the second most closest methodology for our work} 
