...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
	\hline 
	Approach & Tonal Feature & Melodic Aspect & Feature & Transcription & Tonic  & Classification & \#Ragas & Dataset Size (duration/pieces) & Audio Type\tabularnewline
	\hline 
	\hline 
	\cite{belle2009raga} & \cite{rao2009improving} & Svara Iintonation & Svara features derived from PD & No & Manual & \gls{knn} & 4 & 0.6 / 10 & Polyphonic\tabularnewline
	\hline 
	\cite{chordia2007raag} & \cite{sun2000pitch} & Svara salience and \gls{arohana}-\gls{avrohana} & PCD + PCDD & Yes & Manual & \gls{svm} & 31 & 20 / 127 & Monophonic\tabularnewline
	\hline 
	\cite{pandey2003tansen} & \cite{BoersmaPaul2001} & \gls{arohana}-\gls{avrohana} and \textbackslash{}Gls\{raga\} motifs & Svara sequence & Yes & Manual & \gls{hmm} and \gls{ngram} based & 2 & NA / 31 & Monophonic\tabularnewline
	\hline 
	4 &  &  &  &  &  &  &  &  & \tabularnewline
	\hline 
	5 &  &  &  &  &  &  &  &  & \tabularnewline
