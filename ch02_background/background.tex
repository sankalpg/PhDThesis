...
In addition to the \gls{dtw}-based sequence matching approaches there are different variants of the edit distance used in \gls{qbh}. \cite{uitdenbogerd1999melodic} use \gls{lcss} to match query sequence to a MIDI database. \gls{lcss} measures the largest number of common elements in two sequences. DO this review nicely.!!! 
 
%
%
%
%Whole sequence matching 
%DTW - mazzoni2001melody
%cDTW - lijffijt2010benchmarking
%EDR
%ERP
%
%SUBSEQ
...
%RlCS
%
%Dividing sequences subseq->seqs
%Lower bounding
%
%SPRING
%cDTW
%Smith waterman
%SMBGT  - A Subsequence Matching with Gaps-Range-Tolerances Framework : A Query-By-Humming Application
%
%\cite{lijffijt2010benchmarking} performs benchmarking of three different dynamic programming-based methods mentioned above for music retrieval task. The authors report SPRING to be computationally more efficient followed by \gls{cdtw} and \gls{dtw}.
% 
%HMM basd approaches, n-gram based approaches.
% 
%Until recently a majority of the methods were proposed to work on the MIDI databases. Due to the advancements in pitch estimation algoerithms for polyphonic music content, these approaches can now scale to audio collections.
%
%
%
%%String mathicng approaches [66]
%%HMMs [67, 68]
%%Dynamic programming [69, 70]
%%Recursive alignemnt [71]
%
%Problem - > Pitch from query, incorrect singing, timing and pitch accuracy errors..efficient retrieval from the database
%
%
%
%A number of \gls{qbh}  systems have been evaluated in Music Information Retrieval Evaluation eXchange (MIREX) [72].
%
%	Methods for the \gls{qbh}  of audio data have been proposed only quite recently
%	[73, 74, 14, 75, 63]. Typically,Typically, the methods extract the main melodies from the target musical audio (see Sec. 2.3) before the matching takes place. However, it should be noted that a given query melody can in principle be matchedrectly against polyphonic audio data in the time-frequency or time-pitch do- main. Some on-line services incorporating \gls{qbh}  are already available, see e.g. [www.midomi.com], [www.musicline.de], [www.musipedia.org].
%
%
%	
%	
%
%
%Themes or riffs follow pretty much the methodolofy for structure segmentation, but on a shorter time scale. It typically involves computing self similarity etc and then tracking local alignments...etc ...
%
%
%
%\gls{qbh} 
...
%similarity measure..
%Computatinoal complexity
%
%
%Pattern discovery and search in flamenco etc from audio recordings
%Pitch feature
%Transcription vs continuous
%Detection vs discovery
%
%A nice survey on pattern processing in audio refer to klapuri2010pattern
