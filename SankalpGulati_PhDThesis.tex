...
\usepackage[british,catalan,spanish]{babel}
\usepackage{url}
\urlstyle{rm}
\usepackage{enumitem}
...
\newcommand{\tonicChordia}{$\mathrm{M}_\mathrm{PC}$}

\newcommand{\nyasBaselineOne}{$\mathrm{M}_\mathrm{RB1}$}
\newcommand{\nyasBaselineTwo}{$\mathrm{M}_\mathrm{RB2}$}
\newcommand{\nyasBaselineThree}{$\mathrm{M}_\mathrm{RB3}$}
...
%\cleartorecto\include{ch99/quotation}0
