...
\begin{figure}
	...
	\end{center}
	\caption{Boxplot of the average precision values for each pattern type~(PT) in \acrshort{msds_iitm_cmd} and \acrshort{msds_iitb_hmd}. Only the superscript in the name of the dataset is used in the labels.\COMMENT{if time permits change the dataset names in the figure to include full name.}}
