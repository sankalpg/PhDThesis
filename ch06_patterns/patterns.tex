...
\begin{figure}
	...
	\end{center}
	\caption{Histogram of $\mu_\pattern$ for all 100 melodic phrases selected for the listening test.}
...
\begin{table} 
	...
	\begin{tabular}{ l  c c| l | c c }
		...
		%\hline\hline 
	\end{tabular}
	\caption{Mean $\mu_\recording$ and standard deviation $\sigma_\recording$ of $\mu_\pattern$ for each \gls{raga}. R\={a}gas with $\mu_\recording \geq 0.85$ are highlighted. }
