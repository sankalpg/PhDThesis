...
\renewcommand{\title}{Computational Approaches for Description and Characterization of Melodies in Indian Art Music}
...
\usepackage[pdftex,backref=page,hyperfigures,breaklinks,colorlinks,bookmarksopenlevel=0,bookmarksdepth=2
  ...
  pdftitle=Computational~Approaches~for~Description~and~Characterization~of~Melodies~in~Indian~Art~Music
...
\mainmatter
%
%often\cleartorecto\include{ch01_introduction/introduction}
